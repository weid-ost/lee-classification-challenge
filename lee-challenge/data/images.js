// Prototype image set. This test version uses three assessment images.
// Replace with a larger curated set of independent inspection images before a scientific deployment.
const BASE_IMAGES = [
...
window.LEE_IMAGES = Array.from({length:3},(_,i)=>{
